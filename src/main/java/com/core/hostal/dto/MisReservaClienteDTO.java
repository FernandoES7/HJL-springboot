...
public class MisReservaClienteDTO {
    ...
    public MisReservaClienteDTO() {
    }

    public MisReservaClienteDTO(Integer idReserva, String codigoReserva, LocalDate fechaCheckin,
            LocalDate fechaCheckout, Integer numHuespedes, BigDecimal total,
            EstadoReserva estado, boolean cancelable) {
